...
class __TwigTemplate_b74cb8dbbf3b686ba87aa5b242dbcd8d extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "/Users/pad/Dev/pma/templates/preferences/header.twig");
    }
}
